...
def test_tmt_plan_ls_with_custom_fmf_tree(
    ...
    root_logger: Logger # Though not directly used in this test, it's part of the fmf_tree signature
):
    """
    ...
    assert (fmf_root / ".fmf" / "version").is_file(), \
        ".fmf/version was not created by the fixture"
