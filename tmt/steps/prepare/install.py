...
class PrepareInstall(tmt.steps.prepare.PreparePlugin[PrepareInstallData]):
    ...
    Example - Install local rpms using file path:
    ```yaml
    prepare:
        how: install
        package:
    ...
    Example - Install remote packages using url:
    ```yaml
    prepare:
        how: install
        package:
    ...
    Example - Install the whole directory, exclude selected packages:
    ```yaml
    prepare:
        how: install
        directory:
    ...
    Example - Copr with a group owner:
    ```yaml
    prepare:
        how: install
